  ...
  return (
    ...
    >
      <Flex
        ...
        {...getOverrideProps(overrides, "Title, review")}
      >
        <Text
          fontFamily="Lexend"
          fontSize="20px"
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 15776")}
        >
          <Icon
            width="40px"
            height="40px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Nama, Pekerjaan")}
          >
            <Text
              fontFamily="Lexend"
              fontSize="14px"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 15781")}
        >
          <View
            width="28px"
            height="28px"
