...
export declare type EditprofileMazOverridesProps = {
    EditprofileMaz?: PrimitiveOverrideProps<ViewProps>;
...
export declare type EditprofileMazProps = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: EditprofileMazOverridesProps | undefined | null;
}>;
export default function EditprofileMaz(props: EditprofileMazProps): React.ReactElement;
